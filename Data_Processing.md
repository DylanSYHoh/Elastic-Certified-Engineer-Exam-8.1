...
> :books: "Define and use a custom analyzer" is no longer a separate objective in 8.15, but the multi-fields objective still depends on it, so it stays inline below.
